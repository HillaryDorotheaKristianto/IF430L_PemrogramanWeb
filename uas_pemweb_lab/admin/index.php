...
<html>
  ...
  <body>
     <ul>
        ...
        <li class="right"><a href="view/booking_list.php?id=0"><img src="../assets/tickets.png" id="tickets">Booking List</a></li>
        <li class="right"><a href="view/profile.php"><img src="../assets/settings.png" id="settings">Profile</a></li>
      </ul>
				...
				<div class="container">
						<div class="row">
								<div class="content_img">
									...
									<img class="list_hotel" src="../assets/hotel/<?= $mahasiswa['foto'] ?>">
									<p style="text-align:center;">
										<a class="edit_delete" href="controller/hapus_hotel.php?id=<?= $mahasiswa['id_hotel']; ?>">Delete</a>
										<br>
										<a class="edit_delete" href="view/edit_hotel.php?id=<?= $mahasiswa['id_hotel']; ?>">Edit</a>
									</p>
								</div>
						</div>  
				</div>
        ...
        <div class="container">
          <div class="row">
						<div class="content_img">
							...
							<p style="text-align:center;">
								<a class="edit_delete" href="controller/hapus_hotel.php?id=<?= $row['id_hotel']; ?>">Delete</a>
								<br>
								<a class="edit_delete" href="view/edit_hotel.php?id=<?= $row['id_hotel']; ?>">Edit</a>
							</p>
						</div>
          </div>  
        </div>
			...
			<div class="content_img menu_pic">
				<a href="view/add_hotel.php" class="add_menu edit_delete">
					Add Hotel
				</a>
			</div>
  </body>
