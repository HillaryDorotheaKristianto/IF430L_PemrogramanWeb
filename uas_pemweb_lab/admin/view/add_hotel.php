<?php
	require '../controller/insert_hotel.php';
?>
...
<body>
  ...
  <div class="box">
    ...
    <div class="photocontainer left2">
      <img src="../assets/foto.jpg" class="foto">
    </div>
    <form action="" method="post" enctype="multipart/form-data">
      <li class="Nama right2">
        <label>Nama Hotel</label><br>
        <input type="text" placeholder="Nama Hotel" class="searchbar" name="nama_hotel">
      </li>
      <li class="Alamat right2">
        <label>Alamat Hotel</label><br>
        <input type="text" placeholder="Alamat" class="searchbar" name="alamat">
      </li>
      <li class="Alamat right2">
        <label>No. Telp</label><br>
        <input type="text" placeholder="To. Telp" class="searchbar" name="telp">
      </li>
      <li class="Alamat right2">
        <label>Kota</label><br>
        <input type="text" placeholder="Kota" class="searchbar" name="kota">
      </li>
      <li class="Harga right2">
        <label>Harga</label><br>
        <input type="text" placeholder="Harga" class="searchbar" name="harga">
      </li>
      ...
      <li class="Bintang right2">
        ...
        <select name="kamar" class="searchbar">
          <option value="" disabled selected>Kamar</option>
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
          <option value="4">4</option>
