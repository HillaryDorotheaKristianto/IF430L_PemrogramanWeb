...
<body>
    <ul>
        ...
        <!--<li class="right"><a href="user/booking.php"><img src="../assets/tickets.png" id="tickets">Booking List</a></li>-->
        <!--<li class="right"><a href="user/profile.php"><img src="../assets/settings.png" id="settings">Settings</a></li>-->
      </ul>
      <h1>About Us</h1>
