...
<html>
    ...
    <body>
        <ul>
            ...
            <li class="right"><a href="view/cart.php"><img src="assets/cart.png" id="cart"></a></li>
        </ul>
        ...
        <div id="list_menu">
			<div class="container">
			  <div class="row">
				<a href="view/breakfast.php" class="list_menu" data-aos="fade-up">Breakfasts</a>
				<a href="view/dessert.php" class="list_menu">Desserts</a>
				<a href="view/coffee.php" class="list_menu">Coffee</a>
				<a href="view/non_coffee.php" class="list_menu">Non-Coffee</a>
			  </div>  
			</div>
        </div>
    </body>
